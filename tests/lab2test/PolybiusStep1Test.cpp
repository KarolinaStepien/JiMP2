...
class PolybiusStep1Tests : public ::testing::TestWithParam<TestParam>, MemLeakTest {

};

TEST_P(PolybiusStep1Tests, PolybiusCryptShouldReturnExpectedResult) {
...
INSTANTIATE_TEST_CASE_P(PolybiusStep1Tests,
                        PolybiusStep1Tests,
