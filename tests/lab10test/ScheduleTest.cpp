...
TEST_F(ScheduleTest, SchedulerInsertSchedulingItemReturnScheduleOfFirstTeacherWithSingleItem) {
  Schedule schedule;
...
TEST_F(ScheduleTest, SchedulerInsertSchedulingItemReturnScheduleOfFirstTeacherWith3Items) {
  Schedule schedule;
  schedule.InsertScheduleItem(SchedulingItem {0, 1, 2, 3, 4});
...
TEST_F(ScheduleTest, SchedulerInsertSchedulingItemReturnScheduleOfSeventhRoomWith2Items) {
  Schedule schedule;
  schedule.InsertScheduleItem(SchedulingItem {0, 1, 2, 3, 4});
  schedule.InsertScheduleItem(SchedulingItem {5, 33, 7, 8, 9});
  schedule.InsertScheduleItem(SchedulingItem {10, 1, 12, 13, 14});
